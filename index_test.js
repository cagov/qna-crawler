...
const debug_pattern = /^https:\/\/covid19.ca.gov\/(get-tested|vaccines|variants|quarantine-and-isolation|vac-for-the-win)\//;
          ...
          parser.parseString(pdata, async (err, result) => {
              ...
              while (urls.length > 0) {
                ...
                try {
                    ...
                    console.log("Failed to get",url,"pushing to end",e);
                    urls.push(url);
                    await sleep(5000);
                    continue
                }
